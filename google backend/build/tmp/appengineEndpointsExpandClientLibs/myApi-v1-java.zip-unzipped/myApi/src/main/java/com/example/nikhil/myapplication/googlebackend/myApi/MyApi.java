 ...
 * on 2016-05-20 at 07:00:47 UTC 
 * Modify at your own risk.
 */

package com.example.nikhil.myapplication.googlebackend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * parameters, call the {@link AuthenticateUser#execute()} method to invoke the remote operation.
   *
   * @param email
   * @param password
   * @return the request
   */
  public AuthenticateUser authenticateUser(java.lang.String email, java.lang.String password) throws java.io.IOException {
    AuthenticateUser result = new AuthenticateUser(email, password);
    initialize(result);
    return result;
  }

  public class AuthenticateUser extends MyApiRequest<Void> {

    private static final String REST_PATH = "authenticate/{email}/{password}";
     ...
     * parameters, call the {@link AuthenticateUser#execute()} method to invoke the remote operation.
     * <p> {@link AuthenticateUser#initialize(com.google.api.client.googleapis.services.AbstractGoogle
     ...
     * @since 1.13
     */
    protected AuthenticateUser(java.lang.String email, java.lang.String password) {
  ...
  public class SayHi extends MyApiRequest<com.example.nikhil.myapplication.googlebackend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.nikhil.myapplication.googlebackend.myApi.model.MyBean.class);
